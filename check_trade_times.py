...
async def analyze_trade_times(symbol: str, strategy_name: str, start_date: datetime, end_date: datetime):
    ...
    try:
        ...
        if strategy_name == "simple_ma":
            ...
            print("• Generates signals when short MA crosses above/below long MA")
            print("• Best for trending markets")
            
        elif strategy_name == "advanced":
            print("• Multi-Factor Composite Strategy")
            print("• Combines MA, RSI, Bollinger Bands, Volume, and Patterns")
            print("• Uses weighted scoring system")
            
        elif strategy_name == "mean_reversion":
            print("• Statistical Mean Reversion Strategy")
            print("• Buys when price is significantly below mean (Z-score < -1.5)")
            print("• Sells when price is significantly above mean")
            
        elif strategy_name == "low_volume":
            print("• Low-Volume Stock Strategy")
            print("• Optimized for stocks with limited data and high volatility")
            print("• Uses shorter timeframes and volatility scoring")
